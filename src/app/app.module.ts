...
import { DestinyItemInformationsComponent } from './component/destiny/destiny-item/destiny-item-informations/destiny-item-informations.component';
...
@NgModule({
  declarations: [
    ...
    DestinyItemInformationsComponent
  ],
    imports: [
        BrowserModule,
        HttpClientModule,
